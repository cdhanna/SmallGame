...
namespace SmallCommons.Rendering.Bloom
{
    public class BloomComponent //: DrawableGameComponent
    {
        ...
        public RenderTarget2D OutputTarget { get { return outputTarget; } set { outputTarget = value; }}
        public RenderTarget2D SceneTarget { get { return sceneRenderTarget; } set { sceneRenderTarget = value; }}
        ...
        BloomSettings settings = BloomSettings.PresetSettings[4];
        ...
        //}
        public void Init(GraphicsDevice gfx, Effect exactEffect, Effect combineEffect, Effect blurEffect)
        {
            if (gfx == null)
            ...
            bloomExtractEffect = exactEffect;
            bloomCombineEffect = combineEffect;
        ...
        private RenderTarget2D checkRenderTarget(RenderTarget2D target, int width, int height)
        {
            ...
            {
                return new RenderTarget2D(GraphicsDevice, width, height, false, SurfaceFormat.Color, DepthFormat.Depth24Stencil8);
            }
            else return target;
        }
